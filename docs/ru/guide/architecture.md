...
- **Умные уведомления** -- задачи уведомлений коротко ждут, затем отправляют webhook только если сообщение всё ещё не прочитано и уведомления у получателя включены.
...
- `notification.pending` -- уведомление о непрочитанном сообщении готово после проверки статуса прочтения
