...
export const translations: Record<Locale, TranslationStrings> = {
  ...
  ru: {
    ...
    chat: {
      ...
      joinRequired: 'Присоединитесь к чату, чтобы просматривать и отправлять сообщения',
      archived: 'Архивные',
      edited: 'ред.',
  ...
  en: {
    ...
    chat: {
      ...
      joinRequired: 'Join this chat to view and send messages',
      archived: 'Archived',
      edited: 'edited',
      editing: 'Editing',
